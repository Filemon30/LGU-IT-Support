...
<head>
    ...
    <title>City of Biringan - EnchantaTech</title>
...
<body>
    ...
    <main class="landing-page">
        ...
        <section id="home" class="hero-section">
            <div class="hero-text">
                <div class="hero-badge">CITY OF BIRINGAN</div>
            ...
            <div class="hero-image">
                <img src="{{ asset('assets/images/biringan.png') }}" alt="City of Biringan">
            </div>
        </section>
    ...
    <section id="services" class="services-section">
        ...
        <p class="text-center text-sm font-light opacity-75 leading-relaxed max-w-2xl mx-auto">
            Comprehensive EnchantaTech solutions tailored to your needs.
        </p>

        <div class="services-cards mt-12">
        ...
        <div class="timeline-container mt-12">
            <div class="timeline-step step-1">
                ...
                <div class="timeline-content">
                    ...
                    <p class="font-bold text-gray-900">Tell us what's wrong.</p>
            ...
            <div class="timeline-step step-2">
                ...
                <div class="timeline-content">
                    ...
                    <p class="font-bold text-gray-900">Your request gets to the right people.</p>
                    <p class="text-xs">The EnchantaTech team reviews your ticket, checks the issue details, and assigns it for proper handling.</p>
                </div>
            </div>
            ...
            <div class="timeline-step step-3">
                ...
                <div class="timeline-content">
                    ...
                    <p class="font-bold text-gray-900">Get the technical help you need.</p>
            ...
            <div class="timeline-step step-4">
                ...
                <div class="timeline-content">
                    <h3>Confirm & Close</h3>
                    <p class="font-bold text-gray-900">Keep the record complete.</p>
    ...
    <footer class="site-footer">
        <div class="footer-grid">
            <div class="footer-col">
                <div class="footer-brand">
                    ...
                    <div>
                        <span class="footer-title">ENCHANTATECH</span>
        ...
        <div class="footer-bottom">
            <p>&copy; 2026 City of Biringan &mdash; EnchantaTech. All Rights Reserved</p>
        </div>
    </footer>
